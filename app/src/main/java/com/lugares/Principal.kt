...
class Principal : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId){// cuando se seleccione el item
            R.id.action_logoff -> {
                Firebase.auth.singOut()/// se hace la desconeccion
                finish() // termina el activity principal y que aparezca de nuevo el login
                true
